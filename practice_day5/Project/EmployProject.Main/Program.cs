...
namespace EmployProject.Main
{
    internal class Program
    {
        ...
        public static void SearchEmployMain()
        {
            ...
            {
                Console.WriteLine("employ record are not found");
            }
        }
        ...
        public static void AddEmployMain()
        {
            ...
            Console.WriteLine("Enter gender (male/female) ");
            employ.Gender = Console.ReadLine();
            Console.WriteLine("Enter employ department ");
            employ.Dept = Console.ReadLine();
            Console.WriteLine("Enter employ salary ");
            employ.Salary = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine("Enter employ designation ");
            employ.Desig = Console.ReadLine();
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("6. Write to Employ");
            Console.WriteLine("7. Read to Employ");
