...
Insert INTO Student(Sno,Nam,Sub1,Sub2,sub3) Values(1,'vijay',87,74,91) 
GO

Insert into Student(Sno,Nam,Sub1,SUb2,Sub3) values(2,'deva',87,82,91) 
GO

Insert into Student(sno,nam,sub1,sub2,sub3) values(3,'sai',88,77,82) 
GO
